...
class LoginTest(unittest.TestCase):
    ...
    def test_x_Airflow(self):
        ...
        Vertical_flow = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div/div/div/div/div/div[1]/div/div[1]/div[2]/div[6]/span/span[1]')
        Vertical_flow.click()
        sleep(4)
        print('Vertical Air Flow has been turned on successfully')

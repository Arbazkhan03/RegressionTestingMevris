...
class LoginTest(unittest.TestCase):
    ...
    def test_room(self):
        ...
        print('This is the First floor AC no 9.Do you want to change the temperature of AC')
        sleep(5)

    @allure.severity(allure.severity_level.BLOCKER)
    def test_temp_Increase(self):
        temp_increase = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div/div/div/div/div/div[1]/div/div[1]/div[2]/div[1]/div/div/div[2]/div[2]/div/div')
        temp_increase.click()
        print("temperature has been increased successfully")
        sleep(4)
        self.driver.close()

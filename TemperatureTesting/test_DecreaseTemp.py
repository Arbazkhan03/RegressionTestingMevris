...
class LoginTest(unittest.TestCase):
    ...
    def test_temp_decrease(self):
        temp_increase = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div/div/div/div/div/div[1]/div/div[1]/div[2]/div[1]/div/div/div[2]/div[1]/div/div')
        temp_increase.click()
        print("temperature has been decreased successfully")
        sleep(4)
        self.driver.close()

...
class HomePageIconTest(unittest.TestCase):
    ...
    def test_homepage_Icon(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
        sleep(5)
        home_btn = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[1]/div[1]/div/div/div/div/div[1]/div')
        home_btn.click()
        sleep(3)

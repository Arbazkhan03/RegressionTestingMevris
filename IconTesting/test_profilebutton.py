...
class ProfileButtonTest(unittest.TestCase):
    ...
    def test_profile_button(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
        sleep(5)
        profile_btn = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[1]/div[2]/ul[2]/div/div/div/div/div')
        profile_btn.click()
        sleep(3)
        print('This is Profile options.You can change the settings or logout the user from here')

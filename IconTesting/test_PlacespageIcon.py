...
class PlacePageIconTest(unittest.TestCase):
    ...
    def test_placepage_Icon(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
        sleep(5)
        place_btn = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[1]/div[2]/ul[1]/div[1]/div/div')
        place_btn.click()
        sleep(3)
        print('This is place page')

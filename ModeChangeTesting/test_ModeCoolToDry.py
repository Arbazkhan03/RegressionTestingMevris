...
class LoginTest(unittest.TestCase):
    ...
    def test_x_dry(self):
        ...
        Dry_mode = self.driver.find_element_by_xpath('/html/body/div[4]/div[3]/ul/li[2]')
        Dry_mode.click()
        print('Mode has been changed to Dry Mode')
        ...
        # # actions.move_to_element(Mode_change).perform()
        #
        # self.driver.find_element_by_link_text('Dry').click()
        # print("Mode has been Changed to Dry successfully")
        # sleep(4)
        # self.driver.close()

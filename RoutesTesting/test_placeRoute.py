...
class PlaceRouteTest(unittest.TestCase):
    ...
    def test_place_route(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
        sleep(5)
        place_btn = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div/div/div[1]/div/div/div/div[1]/div')
        place_btn.click()
        print('These are the places added in your Mevris Application')
        sleep(5)

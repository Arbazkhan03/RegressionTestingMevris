...
class ProductsRouteTest(unittest.TestCase):
    ...
    def test_products_route(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
        sleep(5)
        products_btn = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div/div/div[3]/div/div/div/div[1]/div/div')
        products_btn.click()
        sleep(3)
        print('This is the list of products that you can add and manipulate accordingly')
        sleep(5)

...
class ThingsRouteTest(unittest.TestCase):
    ...
    def test_things_route(self):
        ...
        warnings.filterwarnings("ignore", category=DeprecationWarning)
        sleep(5)
        things_btn = self.driver.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div/div/div[2]/div/div/div/div[1]/div')
        things_btn.click()
        sleep(3)
        print('These are the things added in your Mevris Application')
        sleep(5)

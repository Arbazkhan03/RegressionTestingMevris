...
class SignUpTest(unittest.TestCase):
    ...
    def test_Valid_SignUp(self):
        ...
        email.send_keys('risings974@gmail.com')
        pswrd = self.driver.find_element_by_name('password')
        pswrd.send_keys('Test@123')
        ...
        btn_signup.click()
        sleep(3)
        print("Your account has been created successfully and a verification code has been sent to your email address")
        sleep(3)
